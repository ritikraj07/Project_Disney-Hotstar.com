...
const Subscribe = () => {
    ...
    return (
        <div style={{
            ...
            <h2>Subscribe to watch all content on Disney+ Hotstar </h2>
            <div className="sub_div">
                <table style={{width:"100%",}}>
                    ...
                    <tr height ="30px">
                        ...
                        <td><img src="https://secure-media.hotstar.com/static/subscription/paywall_service/comparator/tick/smp/web-1x.png" alt="tick" /></td>
                        <td><img src="https://secure-media.hotstar.com/static/subscription/paywall_service/comparator/tick/smp/web-1x.png" alt="tick" /></td>
                    </tr>
                    ...
                    <tr height ="30px">
                        ...
                        <td><img src="https://secure-media.hotstar.com/static/subscription/paywall_service/comparator/cross/smp/web-1x.png" alt="cross" /></td>
                        <td><img src="https://secure-media.hotstar.com/static/subscription/paywall_service/comparator/tick/smp/web-1x.png" alt="tick" /></td>
                    </tr>
                    <tr height ="30px">
