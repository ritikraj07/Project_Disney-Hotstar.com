...
<Splide aria-label="My Favorite Images">
  <SplideSlide>
        ...
        <div className={Style.BackgroundImage}>
                        <img src="https://static-koimoi.akamaized.net/wp-content/new-galleries/2022/11/black-panther-wakanda-forever-movie-review-002.jpg" alt="" className={Style.img} />
        </div>
  ...
  <SplideSlide>
        ...
        <div className={Style.gradiant}></div>
        <div className={Style.BackgroundImage}>
                        <img src="https://th-i.thgim.com/public/entertainment/movies/article23269343.ece/alternates/FREE_1200/Raid" alt="" className={Style.img} />
        </div>
        <div className={Style.Imagetitle}>
            <h2>Raid</h2>
  ...
  <SplideSlide>
        ...
        <div className={Style.gradiant}></div>
        <div className={Style.BackgroundImage}>
                        <img src="https://dl.moviesr.net/images/KzaT7.jpg" alt="" className={Style.img} />
        </div>
        <div className={Style.Imagetitle}>
            <h2>Fursat</h2>
  ...
  <SplideSlide>
        ...
        <div className={Style.gradiant}></div>
        <div className={Style.BackgroundImage}>
                        <img src="https://img1.hotstarext.com/image/upload/f_auto,t_hcdl/sources/r1/cms/prod/old_images/MOVIE/3314/1770003314/1770003314-h" alt="" className={Style.img} />
        </div>
        <div className={Style.Imagetitle}>
  ...
  <SplideSlide>
        ...
        <div className={Style.gradiant}></div>
        <div className={Style.BackgroundImage}>
                        <img src="https://static.joonsite.com/seelatest/2212161837414825.png" alt="" className={Style.img} />
        </div>
        <div className={Style.Imagetitle}>
            <h2>Sembi</h2>
            <p>Drama-2022</p>
